      ...
      >
        <div className="relative flex flex-col-reverse items-center min-h-full py-10 gap-12">
            ...
            {levels.map((level) => {
                ...
                // Dynamic Styling based on level type
                let bgClass = '';
                let borderClass = '';
                let shadowClass = '';
                let textClass = '';
                ...
                if (isUnlocked) {
                    if (isBossLevel) {
                        // Boss Level: Lava / Shiny Red
                        bgClass = 'bg-gradient-to-br from-red-600 via-orange-600 to-red-800';
                        borderClass = 'border-red-200';
                        shadowClass = 'shadow-[0_0_20px_rgba(220,38,38,0.8)]'; // Strong red glow
                    ...
                    if (isBossLevel) {
                        // Locked Boss Level (Hinting at danger)
                ...
                return (
                    ...
                    >
                        ...
                        {isCurrent && (
                            <div className="absolute -top-8 bg-yellow-500 text-slate-900 text-[10px] font-bold px-2 py-1 rounded shadow animate-bounce whitespace-nowrap z-20">
                                GRAJ
                            </div>
                        )}
                    </div>
